document.querySelector('.heart').addEventListener('click', function() {
    ...
    xhr.open('GET', 'memorias.pdf', true); // Asegúrate que el nombre del archivo sea correcto.
    ...
    xhr.onload = function() {
      if (xhr.status === 200) {
        ...
        link.download = 'memorias_de_mi_amor.png'; // Nombre con el que se descarga la carta
        link.click();
